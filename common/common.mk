...
USER_OBJ := ${USER_C:.c=.o}
USER_CPP := ${USER_TARGETS_CPP:=.cpp}
USER_OBJ_CPP := ${USER_C:.cpp=.o}
...
CPPFLAGS ?= -L$(LIBBPF_DIR)/build/usr/include/ -g 
CPPFLAGS += -L../headers/
...
BPF_CFLAGS ?= -I$(LIBBPF_DIR)/build/usr/include/ \
	-I../headers/ \
#	-I/home/admin-ub/bpf-next/include/ \
#	-I/home/admin-ub/bpf-next/arch/x86/include/ \
#	-I/home/admin-ub/bpf-next/arch/alpha/include/

LIBS = -l:libbpf.a -lelf -lz $(USER_LIBS)

all: llvm-check $(USER_TARGETS) $(USER_TARGETS_CPP) $(XDP_OBJ) $(COPY_LOADER) $(COPY_STATS)
...
clean:
	...
	rm -f $(USER_TARGETS) $(USER_TARGETS_CPP) $(XDP_OBJ) $(USER_OBJ) $(COPY_LOADER) $(COPY_STATS)
	rm -f *.ll
	rm -f *~
...
#-$(OBJECT_LIBBPF_C): -$(OBJECT_LIBBPF)
#	$(CC) -Wall $(CFLAGS) $(LDFLAGS) -o $@ $(COMMON_OBJS) \
#	 $< $(LIBS)

#$(USER_TARGETS_CPP): %: %.cpp Makefile $(COMMON_MK) $(COMMON_OBJS) $(KERN_USER_H) $(EXTRA_DEPS)
#	$(GCC) -Wall $(CPPFLAGS) $(LDFLAGS) -o $@ $(COMMON_OBJS) -$(OBJECT_LIBBPF_C) \
#	 $< $(LIBS)
